...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            mapper.writeValue(new File("busTime.json"), timeAndBus);
            ...
            switch (choice) {
                case 1:
                    try {
                        ...
                        if (!(localDate.isBefore(LocalDate.now())) && localTime.isAfter(LocalTime.now())) {
                            f1.checkAvailability(source, destination, bookingDate, bookingTime, timeAndBus, file);
                        } else {
                ...
                case 3:
                    try {
                        ...
                        f1.printBookingDetails(id, file);
                    } catch (Exception e) {
                        System.out.println("--------------------------------------------------------------");
                        System.out.println(e.getMessage());
                        System.out.println("--------------------------------------------------------------");
                ...
                case 4:
                    try {
                        ...
                        int id = scanner.nextInt();
                        f1.cancelBooking(id, timeAndBus, file);
                    } catch (Exception e) {
                        System.out.println("--------------------------------------------------------------");
                        System.out.println(e.getMessage());
                        System.out.println("--------------------------------------------------------------");
