          ...
          <center>
               <div className="w-full pt-2 mt-10 ml-5 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="flex flex-col items-center pb-10">
                        ...
                        <p className="mb-1  font-small  dark:text-white"></p>
                        <span className="text-sm text-gray-500 dark:text-gray-400 font-bold"> Id: </span>
                        <span className="text-sm text-gray-500 dark:text-gray-400 font-bold"> Public Repos:</span>
                        <span className="text-sm text-gray-500 dark:text-gray-400 font-bold"> Public Gists: </span>
                        <span className="text-sm text-gray-500 dark:text-gray-400 font-bold"> Followers: </span>
                        <span className="text-sm text-gray-500 dark:text-gray-400 font-bold" >Following:</span>
