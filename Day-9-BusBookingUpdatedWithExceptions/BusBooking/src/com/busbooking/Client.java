                ...
                case 1: {
                    ...
                    try {
                        ...
                        if (!localDate.isBefore(todaysDate)) {
                            ...
                            facilities.checkBusAvailability(localDate, source, destination,routeAndTime);
                        } else {
                    ...
                    try {
                        ...
                        if (!localDate.isBefore(todaysDate)) {
                            ...
                            if (contact.length() < 10 || contact.length() > 10) {
                                throw new BusBookingException("Invalid Contact Number");
                            }

                            facilities.booking(localDate, source, destination, localTime, noOfSeats, customername,
                                    contact, routeAndTime, billingDetails);
                        } else {
                            throw new BusBookingException("Invalid Date");
                        }
                    } catch (Exception e) {
                        System.out.println(e.getMessage());
                    }
