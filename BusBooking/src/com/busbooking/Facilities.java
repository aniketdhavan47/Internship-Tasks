...
public class Facilities {
    ...
    public void booking(LocalDate date,Map<LocalTime, Bus> timeAndBus, Map<Integer, BillingDetails> billingDetails, String source, String dest) {
        ...
        long contact = sc.nextLong();
            ...
            if (timeAndBus.containsKey(localTime) && (localTime.isAfter(LocalTime.now()))) {
                    ...
                    if (noOfSeats <= bus.getNoOfSeats()) {
                            ...
                            System.out.println(noOfSeats+" "+"Seats not are availables");
