...
<footer className="bg-black text-white rounded-lg shadow dark:bg-gray-900 m-4">
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span className="block text-sm text-white-500 sm:text-center dark:text-white-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Github</a>. All Rights Reserved.</span>
    </div>
</footer>
